...
extern void sha_update(SHA_INFO *, SHA_BYTE *, size_t);
extern void sha_final(unsigned char [20], SHA_INFO *);

extern void sha_stream(unsigned char [20], SHA_INFO *, FILE *);
extern void sha_print(unsigned char [20]);
extern char *sha_version(void);
